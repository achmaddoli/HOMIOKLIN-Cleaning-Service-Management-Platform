            ...
            <div class="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden">
                <div class="p-8 md:p-12">
                    ...
                    <div class="mb-8 border-b border-gray-100 pb-6">
                        <h3 class="text-xl font-bold text-slate-800">Perbarui Data Diri</h3>
                        <p class="text-slate-500 mt-1">Ubah data kontak atau kata sandi untuk akun <span class="font-bold text-slate-700">{{ $user->name }}</span>.</p>
                    </div>
                                ...
                                <div class="bg-orange-50/50 border border-orange-100 p-5 rounded-2xl">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <input type="password" name="password" id="password" class="block w-full px-4 py-3.5 rounded-xl border border-white bg-white focus:ring-2 focus:ring-orange-400 focus:border-orange-400 transition-colors text-slate-800 shadow-sm" placeholder="Kosongkan jika tidak diubah">
                                        </div>
                                        <div>
