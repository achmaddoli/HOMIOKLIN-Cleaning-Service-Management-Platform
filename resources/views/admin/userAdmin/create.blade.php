            ...
            <div class="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden">
                <div class="p-8 md:p-12">
                    ...
                    <div class="mb-8 border-b border-gray-100 pb-6">
                        <h3 class="text-xl font-bold text-slate-800">Detail Data Diri</h3>
                        <p class="text-slate-500 mt-1">Lengkapi form berikut untuk mendaftarkan akun administrator baru.</p>
                    </div>
                    ...
                    <form action="{{ route('user.admin.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" class="block w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-colors text-slate-800" placeholder="Contoh: John Doe" value="{{ old('name') }}" required>
                                </div>
                                <div>
                                    <label for="email" class="block text-sm font-bold text-slate-700 mb-2">Alamat Email</label>
                                    <input type="email" name="email" id="email" class="block w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-colors text-slate-800" placeholder="admin@contoh.com" value="{{ old('email') }}" required>
                                </div>
                                <div>
                            ...
                            <div class="space-y-6">
                                <div>
                                    <label for="hp" class="block text-sm font-bold text-slate-700 mb-2">Nomor Handphone</label>
                                ...
                                <div>
                                    <label for="alamat" class="block text-sm font-bold text-slate-700 mb-2">Alamat Domisili</label>
                                    <textarea name="alamat" id="alamat" class="block w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-colors resize-y text-slate-800" rows="5" placeholder="Tuliskan alamat lengkap..." required>{{ old('alamat') }}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col-reverse sm:flex-row items-center justify-end gap-4 pt-8 mt-4 border-t border-gray-100">
                            <a href="{{ route('user.admin.index') }}" class="w-full sm:w-auto px-6 py-3.5 bg-white border border-gray-200 text-slate-600 font-bold rounded-xl hover:bg-gray-50 hover:text-slate-800 transition-colors text-center">
                                Batal & Kembali
                            </a>
