            ...
            <div class="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden">
                <div class="p-8 md:p-12">
                    ...
                    <div class="mb-8 border-b border-gray-100 pb-6">
                        <h3 class="text-xl font-bold text-slate-800">Detail Data Pekerja / Cleaner</h3>
                        <p class="text-slate-500 mt-1">Lengkapi formulir di bawah ini untuk mendaftarkan staf kebersihan baru ke dalam sistem.</p>
                    </div>

                    <form action="{{ route('user.teknisi.store') }}" method="POST">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" id="email" class="block w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-colors text-slate-800" placeholder="pekerja@homioklin.com" value="{{ old('email') }}" required>
                                </div>
                                <div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="alamat" id="alamat" class="block w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-colors resize-y text-slate-800" rows="5" placeholder="Tuliskan detail alamat tempat tinggal pekerja saat ini..." required>{{ old('alamat') }}</textarea>
                                </div>
                            </div>
