            ...
            <div class="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden">
                <div class="p-8 md:p-12">
                    ...
                    <div class="mb-8 border-b border-gray-100 pb-6">
                        <h3 class="text-xl font-bold text-slate-800">Perbarui Profil Pelanggan</h3>
                        <p class="text-slate-500 mt-1">Ubah identitas, alamat, kontak, atau kata sandi untuk akun <span class="font-bold text-slate-700">{{ $user->name }}</span>.</p>
                    </div>
